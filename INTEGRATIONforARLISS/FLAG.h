...
// 設定用フラグ(1のほうが標準)
#define XBEE_SWITCH 0  // 0にするとxbeeを全て無視します(今は動作不安定っぽい)
...
#define STACK_MODE 0  //0でスタック状況を確かめる。1で面倒なことをしない.
#define DANGER_AREA_FRAG 0 //危険エリア脱出処理を行うならば1.行わないならば0.
#define SD_LOG_FLAG 0  // SDに書き込みを行うなら1.行わないなら0.
#define SPHERE_FLAG 0  // 1で球面三角法を用いる.0では平面として処理.(球面三角法推奨
