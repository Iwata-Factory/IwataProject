...
def main():
    ...
    f.write("#define M1_1 4\n")
    f.write("#define M1_2 5\n")
    f.write("#define M2_1 7\n")
    f.write("#define M2_2 6\n")
    ...
    while True:
        print("")
        print("何をしますか？")
        print("1:滑らかに発進→滑らかに停止")
        print("2:急に発進→急停止")
        print("3:滑らかに右旋回→滑らかに停止")
        print("4:急に右旋回→急停止")
        print("5:滑らかに左旋回→滑らかに停止")
        print("6:急に左旋回→急停止")
        print("7:ランダムに1~6の動きを生成")
        print("8:生成を終了して保存。")
